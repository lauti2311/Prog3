package com.example.ejerciciobidi1;

import com.example.ejerciciobidi1.entidades.Domicilio;
import com.example.ejerciciobidi1.entidades.Persona;
import com.example.ejerciciobidi1.repositorios.DomicilioRepository;
import com.example.ejerciciobidi1.repositorios.PersonaRepository;
...
public class Ejerciciobidi1Application {
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(Ejerciciobidi1Application.class, args);
		System.out.println("Estoy andando con bidireccionalidad");
	}

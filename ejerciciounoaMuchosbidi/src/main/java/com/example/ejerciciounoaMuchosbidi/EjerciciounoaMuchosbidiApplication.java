package com.example.ejerciciounoaMuchosbidi;

import com.example.ejerciciounoaMuchosbidi.entidades.Domicilio;
import com.example.ejerciciounoaMuchosbidi.entidades.Persona;
import com.example.ejerciciounoaMuchosbidi.repositorios.DomicilioRepository;
import com.example.ejerciciounoaMuchosbidi.repositorios.PersonaRepository;
...
public class EjerciciounoaMuchosbidiApplication {
	@Autowired
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(EjerciciounoaMuchosbidiApplication.class, args);
		System.out.println("Estoy probando oneToMany Bidireccional");
	}
